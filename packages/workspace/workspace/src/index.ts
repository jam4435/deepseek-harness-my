...
export class WorkspaceRegistry extends Service {
  ...
  /**
   * Rebuild the header-validated membership projection after persisted session
   * headers change outside ordinary session creation. Workspace records and
   * their durable ordering remain intact.
   * @returns resolution after the refreshed projection is available.
   */
  refreshSessionHeaders(): Promise<void> {
