...
import {
  agentPresetCreateValueSchema, agentPresetEditorOpenValueSchema, agentPresetImportCreateValueSchema, agentPresetImportPreviewValueSchema,
  agentPresetEditorSaveValueSchema, agentPresetListValueSchema, agentPresetOpenDocumentValueSchema,
  agentPresetEditorListFilesValueSchema, agentPresetEditorReadFileValueSchema, agentPresetEditorTestRegexValueSchema,
...
export interface IApiClient {
  ...
  agentPresets: {
    ...
    importPreview(payload: RequestPayload<'agentPreset.importPreview'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'agentPreset.importPreview'>>>
    importCreate(payload: RequestPayload<'agentPreset.importCreate'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'agentPreset.importCreate'>>>
    editorOpen(payload: RequestPayload<'agentPreset.editorOpen'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'agentPreset.editorOpen'>>>
    editorSave(payload: RequestPayload<'agentPreset.editorSave'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'agentPreset.editorSave'>>>
    editorListFiles(payload: RequestPayload<'agentPreset.editorListFiles'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'agentPreset.editorListFiles'>>>
    editorReadFile(payload: RequestPayload<'agentPreset.editorReadFile'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'agentPreset.editorReadFile'>>>
    editorTestRegex(payload: RequestPayload<'agentPreset.editorTestRegex'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'agentPreset.editorTestRegex'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'agentPreset.importPreview': agentPresetImportPreviewValueSchema,
  'agentPreset.importCreate': agentPresetImportCreateValueSchema,
  'agentPreset.editorOpen': agentPresetEditorOpenValueSchema,
  'agentPreset.editorSave': agentPresetEditorSaveValueSchema,
  'agentPreset.editorListFiles': agentPresetEditorListFilesValueSchema,
  'agentPreset.editorReadFile': agentPresetEditorReadFileValueSchema,
  'agentPreset.editorTestRegex': agentPresetEditorTestRegexValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly agentPresets: IApiClient['agentPresets'] = {
    ...
    importPreview: (payload, signal) => this.callUnary('agentPreset.importPreview', payload, signal),
    importCreate: (payload, signal) => this.callUnary('agentPreset.importCreate', payload, signal),
    editorOpen: (payload, signal) => this.callUnary('agentPreset.editorOpen', payload, signal),
    editorSave: (payload, signal) => this.callUnary('agentPreset.editorSave', payload, signal),
    editorListFiles: (payload, signal) => this.callUnary('agentPreset.editorListFiles', payload, signal),
    editorReadFile: (payload, signal) => this.callUnary('agentPreset.editorReadFile', payload, signal),
    editorTestRegex: (payload, signal) => this.callUnary('agentPreset.editorTestRegex', payload, signal),
