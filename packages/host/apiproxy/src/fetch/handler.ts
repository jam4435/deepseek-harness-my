...
import {
  agentPresetCreateRequestSchema, agentPresetEditorOpenRequestSchema, agentPresetImportCreateRequestSchema, agentPresetImportPreviewRequestSchema,
  agentPresetEditorSaveRequestSchema, agentPresetListRequestSchema, agentPresetOpenDocumentRequestSchema,
  agentPresetEditorListFilesRequestSchema, agentPresetEditorReadFileRequestSchema, agentPresetEditorTestRegexRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'agentPreset.importPreview': { schema: agentPresetImportPreviewRequestSchema, invoke: (api, r) => api.agentPresets.importPreview(r) },
  'agentPreset.importCreate': { schema: agentPresetImportCreateRequestSchema, invoke: (api, r) => api.agentPresets.importCreate(r) },
  'agentPreset.editorOpen': { schema: agentPresetEditorOpenRequestSchema, invoke: (api, r) => api.agentPresets.editorOpen(r) },
  'agentPreset.editorSave': { schema: agentPresetEditorSaveRequestSchema, invoke: (api, r) => api.agentPresets.editorSave(r) },
  'agentPreset.editorListFiles': { schema: agentPresetEditorListFilesRequestSchema, invoke: (api, r) => api.agentPresets.editorListFiles(r) },
  'agentPreset.editorReadFile': { schema: agentPresetEditorReadFileRequestSchema, invoke: (api, r) => api.agentPresets.editorReadFile(r) },
  'agentPreset.editorTestRegex': { schema: agentPresetEditorTestRegexRequestSchema, invoke: (api, r) => api.agentPresets.editorTestRegex(r) },
