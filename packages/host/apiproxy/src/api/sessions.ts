...
import type { AgentPresetReference, SessionEvent, SessionId } from '@deepseek-ai/dsh-session/types'
...
export interface SessionsApi {
   ...
   */
  create(request: RpcRequest<{ workspaceId?: WorkspaceId; cwd?: string; sessionId?: SessionId; agentPreset?: AgentPresetReference }>):
  Promise<RpcResponse<{ sessionId: SessionId; agentPreset?: AgentPresetReference }>>
