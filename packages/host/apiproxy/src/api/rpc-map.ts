...
export interface RpcMethodMap {
  ...
  'agentPreset.create': AgentPresetsApi['create']
  'agentPreset.importPreview': AgentPresetsApi['importPreview']
  'agentPreset.importCreate': AgentPresetsApi['importCreate']
  'agentPreset.editorOpen': AgentPresetsApi['editorOpen']
  'agentPreset.editorSave': AgentPresetsApi['editorSave']
  'agentPreset.editorListFiles': AgentPresetsApi['editorListFiles']
  'agentPreset.editorReadFile': AgentPresetsApi['editorReadFile']
  'agentPreset.editorTestRegex': AgentPresetsApi['editorTestRegex']
