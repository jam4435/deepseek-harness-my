...
function scriptedApi(overrides: {
  ...
  return {
    ...
    agentPresets: {
      ...
      importPreview: r => ok(r, { kind: 'unknown' as const, prompts: [], regexes: [], sampling: {}, issues: [] }),
      importCreate: r => ok(r, { agentPreset: r.payload.agentPreset }),
      editorOpen: r => ok(r, {
        agentPreset: r.payload.agentPreset, trust: 'user' as const, composition: '', revision: 'test-revision',
      }),
      editorSave: r => ok(r, { revision: 'test-revision-next' }),
