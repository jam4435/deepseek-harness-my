...
export { SESSION_SEARCH_RESULT_LIMIT, transportError } from '../client-safe.ts'

export type { TypertClientRemote as ClientRemote } from '@deepseek-ai/dsh-typert-protocol'
export type { PluginInventoryAction, PluginInventoryEntry, PluginInventorySnapshot } from '@deepseek-ai/dsh-host-plugin-inventory/types'
...
export type {
  ...
  MuxFrame, PromptContentPart, QuestionResponsePayload, QueueAction, RpcError, RpcId, RpcReceipt, RpcResult,
  RpcRequest, RpcResponse, SessionId, SessionModels, SessionSearchItem,
