...
export interface Config {
  ...
  /** Permanent content-addressed revision repository. */
  revisionRoot?: string
  /** Private materialization parent used only while an immutable revision is mounted. */
  mountRoot?: string
  /** Maximum byte size of one immutable revision. */
  versionBytes?: number
  /** Maximum number of regular files and directories in one revision. */
