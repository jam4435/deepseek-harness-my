...
declare module '@deepseek-ai/dsh-session/types' {
  interface SessionEventMap {
     ...
     */
    'agent-preset/selected': { agentPreset: AgentPresetReference }
  }
}
 ...
 * @returns the exact preset reference, or `undefined` when the deployment composes none.
 */
export function resolveSessionPreset(session: PresetBearingSession): AgentPresetReference | undefined {
