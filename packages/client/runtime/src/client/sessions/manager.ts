...
import { transportError } from '@deepseek-ai/dsh-api-remotes/client-safe'
...
export class SessionManager {
   ...
   * @param agentPreset - the exact preset reference the host confirmed.
   */
  noteAgentPreset(sessionId: SessionId, agentPreset: AgentPresetReference): void {
    this.recordMutation({ kind: 'upsert', summary: {
