...
export interface AgentPresetOption {
  ...
  id: string
  /** Exact current revision submitted when a blank session selects this option. */
...
export interface RosterPreset {
  ...
  id: string
  /** Exact latest revision for new sessions and editor operations. */
  reference: AgentPresetReference
  /** Whether the preset ships with the deployment or was authored locally. */
  trust: 'system' | 'user'
...
export function presetOptions(
  presets: readonly { id: string; reference: AgentPresetReference; trust: 'system' | 'user'; name?: string; description?: string; broken?: string }[],
): AgentPresetOption[] {
