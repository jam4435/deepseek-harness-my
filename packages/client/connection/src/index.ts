...
const PRIVILEGED_METHODS = new Set([
  ...
  // reconnaissance; creation and removal rearrange what the deployment offers, and
  // openDocument drives the host desktop — all more than the roster beside
  // them. The pin is about who may manage the roster at all.
  //
  ...
  'agentPreset.read',
  'agentPreset.create',
  'agentPreset.importPreview',
  'agentPreset.importCreate',
  'agentPreset.editorOpen',
  'agentPreset.editorSave',
  'agentPreset.editorListFiles',
  'agentPreset.editorReadFile',
  'agentPreset.editorTestRegex',
