...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  AssistantMessage: 'model message type is owned by packages/core/llm/README.md',
  AgentPreset: 'discovered preset record is owned by packages/preset/agent-presets/README.md',
  PresetFileEntry: 'preset file-tree entry is owned by packages/preset/agent-presets/README.md',
  PresetFileContent: 'preset file content payload is owned by packages/preset/agent-presets/README.md',
  PresetFileOperation: 'preset file operation payload is owned by packages/preset/agent-presets/README.md',
  PresetMetadata: 'preset display text is owned by packages/preset/agent-presets/README.md',
  SillyTavernImportPreview: 'SillyTavern compatibility preview is owned by packages/preset/agent-presets/README.md',
