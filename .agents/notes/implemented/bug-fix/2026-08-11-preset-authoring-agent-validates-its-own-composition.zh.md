...
取代[破损 preset 是 roster 行](2026-08-09-broken-preset-roster-rows.md)中关于创作模式指导的那一条，其健康检查决策依然有效——本篇只推翻它「agent 起不了会话；设置页的红色标记是用户的检查手段」这一结论。浏览器创作由[预设工作室创作](../feature/2026-08-17-preset-studio-authoring.md)负责。
